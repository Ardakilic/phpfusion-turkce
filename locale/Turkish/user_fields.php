...
$locale['uf_102'] = "Kullanıcı Avatarı (Profil Resmi) Ayarları";
$locale['uf_103'] = "Genel";
$locale['uf_104'] = "Kullanıcı Bilgisi";
$locale['uf_105'] = "Profil Resmi";
$locale['uf_106'] = "Genel Bilgiler";
$locale['uf_107'] = "%s bir kullanıcı bilgisine sahip değil.";
...
$locale['u145'] = "Admin parolasını doğrulayın";
...
Sitemiz olan ".$settings['sitename']." adresine hoş geldiniz. Giriş bilgileriniz aşağıdadır:\n
...
$locale['u182'] = "Avatar boyutu ".$settings['avatar_width']."x".$settings['avatar_height']." pikselden yüksek olmamalıdır.";
...
$locale['u202'] = "E-posta adresi doğrulama - ".$settings['sitename'];
